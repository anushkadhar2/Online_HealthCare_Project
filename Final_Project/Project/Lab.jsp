...
<div id="container">
	...
	<img class="header-image" src="images/lab.jpg" width = "100%" height = "100%" alt="Index Page Image" />
  ...
  <form method="get" action="LabRecords">
		
		<fieldset>
			<legend>Please provide the details to complete the data tranfer to the database:</legend>
		
			<table>
						
				<tr>
					<td> Lab ID: </td>
					<td> <input type="text" name="LabID" value=''> </td>         
				</tr>

				<tr>
					<td> Lab Password: </td>
					<td> <input type="text" name="labpassword" value=''> </td>         
				</tr>
		...
		<fieldset>
			...
			<br><center><input type="submit" value="Submit Details"> </center>
    ...
    <aside class="sidebar">
            ...
            <ul>	
               <li>
                    <h4>Get Online</h4>
                    <ul>
                        <li><a href="#">Register your lab</a></li>
                    </ul>
                </li>
